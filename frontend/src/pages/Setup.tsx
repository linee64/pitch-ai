...
import { Upload, FileText, Check, ArrowRight, Brain, Clock, ChevronLeft, Plus, Image as ImageIcon } from "lucide-react";
                  ...
                  >
                    <div className="flex gap-4 p-3">
                      ...
                      <div className="flex-1 min-w-0 py-1">
                        <div className="text-[10px] font-mono uppercase tracking-widest text-primary truncate">{t("setup.conflyAdvisor")}</div>
                  ...
                  <div className="grid gap-6 py-4">
                    <div className="grid gap-2">
                      ...
                      <label className="relative h-32 rounded-xl border-2 border-dashed border-border bg-secondary/20 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-secondary/40 transition-colors overflow-hidden">
                        ...
                        {advisorPhoto ? (
                          <>
                            <img src={advisorPhoto} alt="Preview" className="absolute inset-0 size-full object-cover mix-blend-luminosity opacity-60" />
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input id="name" placeholder="Elias Vance" className="bg-secondary/40 border-border" />
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="role" className="text-xs font-mono uppercase tracking-widest text-muted-foreground">{t("setup.advisorRole")}</Label>
                      <Input id="role" placeholder="Product Manager" className="bg-secondary/40 border-border" />
                    </div>
                  </div>
                  <DialogFooter>
                    <button 
                      onClick={() => setIsDialogOpen(false)}
                      className="w-full h-11 rounded-xl bg-fluid text-background font-semibold text-sm shadow-glow-cyan hover:scale-[1.01] transition-transform"
                    >
                      {t("setup.saveAdvisor")}
                    </button>
                  </DialogFooter>
