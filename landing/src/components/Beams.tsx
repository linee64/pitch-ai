...
export const Beams: React.FC<BeamsProps> = ({
  ...
  useEffect(() => {
    ...
    renderer.setClearColor(0x000000, 0); // Transparent background to blend with site
...
vec3 getNormal(vec3 pos) {
  ...
  gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
    ...
    directionalLight = new THREE.DirectionalLight(new THREE.Color(lightColor), 1);
  ...
  return <div ref={containerRef} className="beams-container w-full h-full relative" />;
};
